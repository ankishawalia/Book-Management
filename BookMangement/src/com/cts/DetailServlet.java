...
public class DetailServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String addUserDetail = userDao.addUserDetail(book);
		...
		if(addUserDetail!=null) {
			...
			RequestDispatcher rd=request.getRequestDispatcher("/entry-success.jsp");
			rd.forward(request, response);
		}
		else {
			RequestDispatcher rd=request.getRequestDispatcher("/entry-error.jsp");
			rd.forward(request, response);
		}
